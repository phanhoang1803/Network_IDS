...
def parse_args():
    ...
    parser.add_argument("--save_dir", type=str, default="Model directory for loading or saving", help="Directory to save model")
...
def fetch_model(CONFIG):
    if CONFIG["model_name"] == "MLP":
        model = MLP(input_dim=CONFIG["input_dim"], hidden_dims=[32], output_dim=2)
